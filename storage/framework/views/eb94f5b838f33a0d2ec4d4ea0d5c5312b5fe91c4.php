...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('dashboard.index')).'','active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('dashboard.index'))]); ?>.index
                <?php echo e(__('Dashboard')); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('dashboard.category.index')).'','active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('dashboard.category.index'))]); ?>.index
                <?php echo e(__('Category')); ?>
...
<?php /**PATH /Users/rickypranata/Desktop/laravelApp/shamo-backend/resources/views/navigation-menu.blade.php ENDPATH**/ ?>